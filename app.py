  ...
  class TwitterClient(object): 
    def __init__(self): 
        ...
        try: 
            ...
            auth = OAuthHandler('rnFqkycbJNjI6B9k7jFD2FKgk', 'BJ6CL54waQlJ5D4abPeoH28gvpkNqmO3WPnvod4jkPc2BE3zjs') 
            # set access token and secret 
            auth.set_access_token('1390578648093138947-2wyWYPaWq8hQhvAupze1pZBjPQsCYU', 'gV2fqEA1nqwTatzQ3L6sVqKM9fWvMugt0iqx3jTezJvlu') 
